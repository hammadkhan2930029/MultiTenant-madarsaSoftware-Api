...
const EXTRA_PERMISSIONS = [
  ...
  ['teachers.assignments.view', 'Teachers', 'View Teacher Assignments', 'Can view teacher subject and responsibility assignments', '/teachers/assignments', 'assignments.view'],
  ['teachers.assignments.create', 'Teachers', 'Create Teacher Assignments', 'Can create teacher subject and responsibility assignments', '/teachers/assignments', 'assignments.create'],
  ['teachers.assignments.edit', 'Teachers', 'Edit Teacher Assignments', 'Can edit teacher subject and responsibility assignments', '/teachers/assignments', 'assignments.edit'],
  ['teachers.assignments.delete', 'Teachers', 'Delete Teacher Assignments', 'Can remove teacher subject and responsibility assignments', '/teachers/assignments', 'assignments.delete'],
  ...
  ['settings.departments.create', 'Settings', 'Create Departments', 'Can create departments', '/settings/departments', 'departments.create'],
  ['settings.departments.update', 'Settings', 'Update Departments', 'Can update departments', '/settings/departments', 'departments.update'],
  ['settings.departments.delete', 'Settings', 'Delete Departments', 'Can delete departments', '/settings/departments', 'departments.delete'],
