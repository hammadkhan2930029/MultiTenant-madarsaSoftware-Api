...
const permissions = [
  ...
  { key: 'roles.manage', name: 'Roles Manage', path: '/role-management', module: 'role_management' },
  ...
  { key: 'users.manage', name: 'Users Manage', path: '/role-management/users', module: 'users' },
  ...
  { key: 'settings.departments.create', name: 'شعبہ شامل کریں', path: '/setting/department', module: 'settings' },
  { key: 'settings.departments.update', name: 'شعبہ تبدیل کریں', path: '/setting/department', module: 'settings' },
  { key: 'settings.departments.delete', name: 'شعبہ حذف کریں', path: '/setting/department', module: 'settings' },
