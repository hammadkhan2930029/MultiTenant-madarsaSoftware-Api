...
export const createParent = asyncHandler(async (req, res) => {
  const parent = await parentsService.createParent(req.tenantId, req.body, req.branchScope);
...
export const getParents = asyncHandler(async (req, res) => {
  const parents = await parentsService.getParents(req.tenantId, req.query, req.branchScope);
...
export const updateParent = asyncHandler(async (req, res) => {
  const parent = await parentsService.updateParent(req.tenantId, Number(req.params.id), req.body, req.branchScope);
