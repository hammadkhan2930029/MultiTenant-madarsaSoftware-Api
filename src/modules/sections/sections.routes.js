...
router.get('/', requireResourceRead('sections', 'sections.view'), validate(listSectionsValidationSchema), getSections);
router.get('/:id', requireResourceRead('sections', 'sections.view'), validate(sectionIdValidationSchema), getSectionById);
