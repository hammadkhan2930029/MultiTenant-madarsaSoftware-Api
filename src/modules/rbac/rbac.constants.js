...
export const SUPPORTING_READ_PERMISSIONS = {
  students: [
    'students.create', 'students.edit', 'students.assign_class',
    'parents.view', 'parents.create', 'parents.edit',
    'students.id_card.view', 'attendance.view', 'attendance.create', 'attendance.edit',
    'attendance.history.view',
    'student_fees.view', 'student_fees.create', 'student_fees.collect',
    'student_fees.history', 'student_fees.edit',
  ...
  parents: ['students.create', 'students.edit'],
  classes: [
  ...
  teachers: [
    ...
    'teachers.attendance.create', 'teachers.attendance.edit', 'teachers.attendance.delete', 'teachers.assignments.view',
