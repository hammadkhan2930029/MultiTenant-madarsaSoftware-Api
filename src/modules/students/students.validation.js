...
const studentBodySchema = z.object({
  ...
  classId: z.coerce.number().int().positive('Class id must be a valid number.').optional(),
  sectionId: z.coerce.number().int().positive('Section id must be a valid number.').optional(),
