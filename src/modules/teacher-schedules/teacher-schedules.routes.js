...
import { createTeacherSchedule, deleteTeacherSchedule, getTeacherSchedules, updateTeacherSchedule } from './teacher-schedules.controller.js';
import {
  createTeacherScheduleValidationSchema,
  listTeacherSchedulesValidationSchema,
  teacherScheduleIdValidationSchema,
  updateTeacherScheduleValidationSchema,
...
router.put('/:id', requirePermission('teachers.update'), validate(updateTeacherScheduleValidationSchema), updateTeacherSchedule);
