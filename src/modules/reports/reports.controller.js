...
export const getStudentsReport = asyncHandler(async (req, res) => {
  const report = await reportsService.getStudentsReport(req.tenantId, req.query);
...
export const getAttendanceReport = asyncHandler(async (req, res) => {
  const report = await reportsService.getAttendanceReport(req.tenantId, req.query);
  return apiResponse(res, {
...
export const getHifzProgressReport = asyncHandler(async (req, res) => {
  const report = await reportsService.getHifzProgressReport(req.tenantId, req.query);
  return apiResponse(res, {
...
export const getFundCollectionsReport = asyncHandler(async (req, res) => {
  const report = await reportsService.getFundCollectionsReport(req.tenantId, req.query);
  return apiResponse(res, {
...
export const getSalaryReport = asyncHandler(async (req, res) => {
  const report = await reportsService.getSalaryReport(req.tenantId, req.query);
  return apiResponse(res, {
...
export const getMonthlyFinanceSummaryReport = asyncHandler(async (req, res) => {
  const report = await reportsService.getMonthlyFinanceSummaryReport(req.tenantId, req.query);
  return apiResponse(res, {
