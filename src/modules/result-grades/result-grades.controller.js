...
export const createResultGrade = asyncHandler(async (req, res) => {
  const result = await resultGradesService.createResultGrade(req.tenantId, req.body, req.branchScope);
...
export const getResultGrades = asyncHandler(async (req, res) => {
  const result = await resultGradesService.getResultGrades(req.tenantId, req.query, req.branchScope);
...
export const getResultGradeById = asyncHandler(async (req, res) => {
  const result = await resultGradesService.getResultGradeById(req.tenantId, req.params.id, req.branchScope);
...
export const updateResultGrade = asyncHandler(async (req, res) => {
  const result = await resultGradesService.updateResultGrade(req.tenantId, req.params.id, req.body, req.branchScope);
...
export const deleteResultGrade = asyncHandler(async (req, res) => {
  const result = await resultGradesService.deleteResultGrade(req.tenantId, req.params.id, req.branchScope);
