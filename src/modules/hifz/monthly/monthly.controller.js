...
export const createMonthlyEntry = asyncHandler(async (req, res) => {
  const entry = await monthlyHifzService.createEntry(req.tenantId, req.body, req.branchScope);
...
export const getMonthlyEntries = asyncHandler(async (req, res) => {
  const entries = await monthlyHifzService.getEntries(req.tenantId, req.query, req.branchScope);
...
export const getMonthlyEntryById = asyncHandler(async (req, res) => {
  const entry = await monthlyHifzService.getEntryById(req.tenantId, Number(req.params.id), req.branchScope);
...
export const updateMonthlyEntry = asyncHandler(async (req, res) => {
  const entry = await monthlyHifzService.updateEntry(req.tenantId, Number(req.params.id), req.body, req.branchScope);
...
export const deactivateMonthlyEntry = asyncHandler(async (req, res) => {
  const entry = await monthlyHifzService.deactivateEntry(req.tenantId, Number(req.params.id), req.branchScope);
