...
export const generateStudentFees = asyncHandler(async (req, res) => {
  const result = await studentFeesService.generateFees(req.tenantId, req.body);
...
export const getStudentFees = asyncHandler(async (req, res) => {
  const result = await studentFeesService.getFees(req.tenantId, req.query);
...
export const getStudentFeeById = asyncHandler(async (req, res) => {
  const result = await studentFeesService.getFeeById(req.tenantId, Number(req.params.id));
...
export const getStudentFeeHistory = asyncHandler(async (req, res) => {
  const result = await studentFeesService.getStudentFeeHistory(req.tenantId, Number(req.params.studentId));
...
export const saveStudentFeePayment = asyncHandler(async (req, res) => {
  const result = await studentFeesService.savePayment(req.tenantId, Number(req.params.id), req.body);
