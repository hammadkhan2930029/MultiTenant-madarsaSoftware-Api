...
export const createFundCollection = asyncHandler(async (req, res) => {
  const entry = await fundCollectionsService.createEntry(req.tenantId, req.body);
...
export const getFundCollections = asyncHandler(async (req, res) => {
  const entries = await fundCollectionsService.getEntries(req.tenantId, req.query);
...
export const getFundCollectionById = asyncHandler(async (req, res) => {
  const entry = await fundCollectionsService.getEntryById(req.tenantId, Number(req.params.id));
...
export const updateFundCollection = asyncHandler(async (req, res) => {
  const entry = await fundCollectionsService.updateEntry(req.tenantId, Number(req.params.id), req.body);
...
export const deactivateFundCollection = asyncHandler(async (req, res) => {
  const entry = await fundCollectionsService.deactivateEntry(req.tenantId, Number(req.params.id));
