...
export const getFinanceSummaryReport = asyncHandler(async (req, res) => {
  const report = await reportsService.getFinanceSummary(req.tenantId, req.query, req.branchScope);
...
export const getStudentFundHistoryReport = asyncHandler(async (req, res) => {
  const report = await reportsService.getStudentFundHistory(req.tenantId, req.query, req.branchScope);
...
export const getTeacherSalaryHistoryReport = asyncHandler(async (req, res) => {
  const report = await reportsService.getTeacherSalaryHistory(req.tenantId, req.query, req.branchScope);
