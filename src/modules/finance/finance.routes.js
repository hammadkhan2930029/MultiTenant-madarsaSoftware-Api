...
router.post('/expenses', authMiddleware, requirePermission('finance.transactions.create'), createExpense);
router.get('/expenses', authMiddleware, requirePermission('finance.transactions.view'), getExpenses);
